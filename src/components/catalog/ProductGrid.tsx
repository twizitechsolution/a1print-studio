...
import { ChevronDown, ChevronUp, Layers, Filter } from 'lucide-react';
...
export const ProductGrid: React.FC<ProductGridProps> = ({
  ...
  return (
    <section id="catalog" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 font-sans select-none">
      ...
      {/* 2-Column Desktop Grid Layout matching LovecraftbySE reference screenshot */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        
        {/* Left Sidebar Category & Subcategory Filter (4 Cols on LG) */}
        <div className="lg:col-span-4 lg:col-span-3 bg-white p-5 rounded-3xl border border-gray-200 shadow-xs space-y-4">
        ...
        {/* Right Column: Product Cards Grid (9 Cols on LG) */}
        <div className="lg:col-span-8 lg:col-span-9 space-y-6">
